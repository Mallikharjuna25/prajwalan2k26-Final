...
import { FiGrid, FiPlusSquare, FiUser, FiLogOut, FiMenu, FiX } from 'react-icons/fi';
...
const OrganizerSidebar = () => {
    ...
    const navItems = [
        { name: 'My Events', path: '/organizer/dashboard', icon: <FiGrid /> },
        { name: 'Create Event', path: '/organizer/dashboard/create', icon: <FiPlusSquare /> },
        { name: 'Profile', path: '/organizer/dashboard/profile', icon: <FiUser /> },
    ];

    const SidebarContent = () => (
        <div className="flex flex-col h-full bg-surface-card border-r border-surface-border w-64 md:w-72">
            <div className="p-6">
                <h2 className="text-2xl font-heading font-bold text-gradient">Organizer Pannel</h2>
            </div>
